...
const AppLayout: FC<Props> = ({ children }) => {
  return (
    <div className="flex h-screen w-screen dark:bg-neutral-950 md:p-3">
                  ...
                  <ul className="mt-2 ml-2 space-y-2">
                    {item.items.map((item) => (
                      <li key={item.name}>
                        <Link
                          href={item.href}
                          className="flex items-center px-4 py-2 mr-2 text-gray-400 hover:bg-gray-100 hover:text-gray-900 rounded duration-200"
                        >
                          <Icon
                            iconName={item.icon}
                            size={17}
        ...
        <div className="mb-2">
          <div className="flex justify-between items-center">
            ...
            <div className="text-nowrap">
              <div className="text-sm text-gray-200">Arthurncious Monethi</div>
